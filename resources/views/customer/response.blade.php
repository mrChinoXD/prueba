                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="{{route('customer.show',$product->id)}}" class="btn btn-info btn-outline-secondary">Ver</a>
                                <a href="{{route('customer.buy',$product->id)}}" class="btn btn-sm btn-outline-secondary">Comprar</a>
                            </div>
