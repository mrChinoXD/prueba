        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ route('admin.customers.addbalance',$user->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="number" id="name" class="form-control" name="balance" value="{{$user->balance}}">
